...
run_infer() {
    ...
    CUDA_VISIBLE_DEVICES=$cuda_id python infer_cli_editing.py \
        --save_root $save_root \
...
# ===== Run (Editing) =====
evalset_root="/storage/zhangxueyao/workspace/SpeechGenerationYC/EvalSet/editing_speech"
task_name="editing_speech"

run_infer 4 "genshin_tts_en" $evalset_root
run_infer 5 "genshin_tts_zh" $evalset_root

evalset_root="/storage/zhangxueyao/workspace/SpeechGenerationYC/EvalSet/editing_singing"
task_name="editing_singing"
